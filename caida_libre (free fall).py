...
while 1:
    ...
    if bola1.pos.y > 0.5 or bola2.pos.y > 0.5:                    
            ...
            #x = x(o) = 0
            #Vy = Voy - g*t = -gt
            #y = yo + Voy*t - (1/2 * g*t**2) = -4.9*t**2  ---> con g = 9.8
            #
            ...
            altura.text="Altura: " + str(round(bola2.pos.y, 2)) + " m"
                        
            velocidad.text="Velocidad: " + str(round(velocidadBola, 2)) + " m/s"
                        
            tiempo.text = " t caida: " + str(round(t, 2)) + " s"
